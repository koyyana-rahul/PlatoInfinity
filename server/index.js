...
// console.log("address routes mounted");
...
// ------------------------------------------------
// ✅ PRODUCTION-SAFE CORS (IMPORTANT)
// ------------------------------------------------
const allowedOrigins = [
  "https://plato-infinity.xyz",
  "https://www.plato-infinity.xyz",
  "http://localhost:5173",
];
...
// ------------------------------------------------
app.get("/", (req, res) => {
  res.json({ ok: true, message: "Plato API Server" });
});
